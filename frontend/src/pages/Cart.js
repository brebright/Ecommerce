...
const Cart = () => {
    ...
    const handlePaymentClick = () => {
        navigate('/checkout', { state: { totalAmount: totalPrice, totalQuantity: totalQty } });
    };
    ...
    return (
        ...
        <div className='w-32 h-32 bg-slate-200'>
           ...
           <div className='px-4 py-2 relative'>
            ...
            <p className='capitalize text-slate-500'>{product?.productId?.category || "Uncategorized"}</p>
            <div className='flex items-center justify-between'>
                <p className='text-purple-600 font-medium text-lg'>{displayINRCurrency(product?.productId?.sellingPrice || 0)}</p>
                ...
                <div className='mt-5 lg:mt-0 w-full max-w-sm'>
                    {loading ? (
                        ...
                        <div className='h-36 bg-white'>
                            ...
                            <button className='bg-blue-600 p-2 text-white w-full mt-2' onClick={handlePaymentClick}>Payment</button>
                        </div>
                    )}
                </div>
            </div>
