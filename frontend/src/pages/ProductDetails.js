...
//                   <img src={activeImage} alt='imges' className='h-full w-full object-scale-down mix-blend-multiply' onMouseMove={handleZoomImage} onMouseLeave={handleLeaveImageZoom}/>
...
//                 <p className='bg-purple-300 px-5 text-white px-2 rounded-full inline-block w-fit'>{data?.brandName}</p>
...
//                   <p className='text-purple-600'>{displayETBCurrency(data.sellingPrice)}</p>
